...
#define PACKAGE_STRING "pcsc-lite 1.6.1"
...
#define PCSCLITE_FEATURES " Linux i686-pc-linux-gnu serial usb usbdropdir=/usr/local/pcsc/drivers ipcdir=/data/local/tmp sysconfdir=/system/etc"
...
#define USE_IPCDIR "/data/local/tmp"
